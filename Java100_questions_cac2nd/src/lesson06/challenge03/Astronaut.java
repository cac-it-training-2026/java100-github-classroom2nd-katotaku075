...
class Spaceship {
	...
	int consumeFuel() {
		...
		int lightYears = this.fuel * 10;
		return lightYears;
	}

	int consumeFuel(int fuel) {
		this.fuel -= fuel;
...
public class Astronaut {
	...
	public static void main(String[] args) throws IOException {
		...
		//ここに適切な処理を記述する。
		System.out.println("航行距離：" + spaceship.consumeFuel() + "光年");
		...
		//ここに適切な処理を記述する。
		System.out.println("航行距離：" + spaceship.consumeFuel(consumingFuel) + "光年");
